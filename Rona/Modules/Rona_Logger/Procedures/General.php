				...
				if ($total_entries) {
					...
					ob_start();
						...
						<p>
							...
							?>
							<small><em>This report contains log entries for the past <?php echo $this->config('email_report.minute_interval') ?> minute<?php echo $this->config('email_report.minute_interval') == 1 ? '' : 's' ?> and was generated by <?php echo $this->config('display_name') ?>.</em></small>
						</p>
						<?php
					$body = ob_get_clean();
